...
$statusOptions = [
    ['status' => 'No PLA (No Public Land Application)'],
    ['status' => 'SA (Survey Authority)'],
    ['status' => 'FPA (Free Patent Application)'],
    ['status' => 'RSA (Request for Survey Authority)'],
    ['status' => 'RFPA (Request for Free Patent Application)'],
];
...
<?php include 'user_navbar.php'; ?>
        ...
        <form method="POST" action="user_edit_submitted.php">
             <!-- Hidden field for notif_id -->
    <input type="hidden" name="notif_id" value="<?php echo isset($row['notif_id']) ? $row['notif_id'] : ''; ?>">
    <div class="form-container">
    <div class="row">
    <div class="col-md-6"> <!-- Adjusted column for medium-sized screens -->
        <div class="card">
            <div class="card-header">
                <h4>Edit Submitted Land Title</h4>
            </div>
            <div class="card-body">
                <div class="form-group">
                    <label for="lot_number">Lot Number</label>
                    <input type="text" class="form-control" id="lot_number" name="lot_number" placeholder="Enter Lot Number" value="<?php echo isset($row['lot_number']) ? htmlspecialchars($row['lot_number']) : ''; ?>" >
                </div>
                <div>
        ...
        ?>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date_approved" required value="<?php echo isset($row['date_approved']) ? $row['date_approved'] : ''; ?>">
                </div>
            </div>
        </div>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="applicantLastName" name="applicantLastName" placeholder="Enter Last Name" value="<?php echo isset($row['applicantLastName']) ? $row['applicantLastName'] : ''; ?>">
        </div>
        <div class="form-group">
            <label for="applicantFirstName">First Name</label>
            <input type="text" name="applicantFirstName" class="form-control" id="applicantFirstName" placeholder="Enter First Name" value="<?php echo isset($row['applicantFirstName']) ? $row['applicantFirstName'] : ''; ?>">
        </div>
        <div class="form-group">
            <label for="applicantMiddleName">Middle Name</label>
            <input type="text" class="form-control" name="applicantMiddleName" id="applicantMiddleName" placeholder="Enter Middle Name" value="<?php echo isset($row['applicantMiddleName']) ? $row['applicantMiddleName'] : ''; ?>">
        </div>
        <div class="form-group form-check">
            <input type="checkbox" class="form-check-input" id="extensionCheck" <?php echo isset($row['applicantExtension']) && $row['applicantExtension'] ? 'checked' : ''; ?>>
            <label class="form-check-label" for="extensionCheck">Extensions</label>
            <input type="text" class="form-control mt-2" name="applicantExtension" id="applicantExtension" placeholder="Enter Extensions" style="<?php echo isset($row['applicantExtension']) && $row['applicantExtension'] ? '' : 'display: none;'; ?>" value="<?php echo isset($row['applicantExtension']) ? $row['applicantExtension'] : ''; ?>">
        </div>
        <div class="form-group">
            <label for="applicantSex">Sex</label>
            <select class="form-control" id="applicantSex" name="applicantSex">
                <option <?php echo isset($row['applicantSex']) && $row['applicantSex'] == 'Male' ? 'selected' : ''; ?>>Male</option>
                <option <?php echo isset($row['applicantSex']) && $row['applicantSex'] == 'Female' ? 'selected' : ''; ?>>Female</option>
            </select>
        </div>
        <div class="form-group">
            <label for="applicantBirthday">Birthday</label>
            <input type="date" class="form-control" id="applicantBirthday" name="applicantBirthday" placeholder="Select Birthday" required value="<?php echo isset($row['applicantBirthday']) ? $row['applicantBirthday'] : ''; ?>">
        </div>
        <div class="form-group">
            <label for="applicantAge">Age</label>
            <input type="text" class="form-control" id="applicantAge" name="applicantAge" placeholder="Enter Age" readonly value="<?php echo isset($row['applicantAge']) ? $row['applicantAge'] : ''; ?>" >
        </div>
        <div class="form-group">
            <label for="applicantContactNumber">Contact Number</label>
            <input type="text" class="form-control" id="applicantContactNumber" name="applicantContactNumber" placeholder="Enter Contact Number" maxlength="11" value="<?php echo isset($row['applicantContactNumber']) ? $row['applicantContactNumber'] : ''; ?>">
        </div>
        <!-- Civil Status Dropdown for Applicant -->
        <div class="form-group">
            <label for="applicantCivilStatus">Civil Status</label>
            <select class="form-control" id="applicantCivilStatus" name="applicantCivilStatus" onchange="toggleSpouseField()" required>
                <option value="Single" <?php if (isset($row['applicantCivilStatus']) && $row['applicantCivilStatus'] == 'Single') echo 'selected'; ?>>Single</option>
                <option value="Married" <?php if (isset($row['applicantCivilStatus']) && $row['applicantCivilStatus'] == 'Married') echo 'selected'; ?>>Married</option>
                <option value="Separated" <?php if (isset($row['applicantCivilStatus']) && $row['applicantCivilStatus'] == 'Separated') echo 'selected'; ?>>Separated</option>
                <option value="Widow" <?php if (isset($row['applicantCivilStatus']) && $row['applicantCivilStatus'] == 'Widow') echo 'selected'; ?>>Widow</option>
            </select>
        </div>
        ...
        <div class="form-group" id="spouseField" style="display: none;">
            ...
            <input type="text" class="form-control" id="applicantSpouseName" name="applicantSpouseName" placeholder="Enter Spouse/Partner Name" value="<?php echo isset($row['applicantSpouseName']) ? $row['applicantSpouseName'] : ''; ?>">
        </div>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="claimantLastName" name="claimantLastName" placeholder="Enter Last Name" value="<?php echo isset($row['claimantLastName']) ? $row['claimantLastName'] : ''; ?>">
        </div>
        <div class="form-group">
            <label for="claimantFirstName">First Name</label>
            <input type="text" class="form-control" id="claimantFirstName" name="claimantFirstName" placeholder="Enter First Name" value="<?php echo isset($row['claimantFirstName']) ? $row['claimantFirstName'] : ''; ?>">
        </div>
        <div class="form-group">
            <label for="claimantMiddleName">Middle Name</label>
            <input type="text" class="form-control" id="claimantMiddleName" name="claimantMiddleName" placeholder="Enter Middle Name" value="<?php echo isset($row['claimantMiddleName']) ? $row['claimantMiddleName'] : ''; ?>">
        </div>
        <div class="form-group form-check">
            <input type="checkbox" class="form-check-input" id="claimantExtensionCheck" <?php echo isset($row['claimantExtension']) && $row['claimantExtension'] ? 'checked' : ''; ?> disabled>
            <label class="form-check-label" for="claimantExtensionCheck">Extensions</label>
            <input type="text" class="form-control mt-2" name="claimantExtension" id="claimantExtension" placeholder="Enter Extensions" style="<?php echo isset($row['claimantExtension']) && $row['claimantExtension'] ? '' : 'display: none;'; ?>" value="<?php echo isset($row['claimantExtension']) ? $row['claimantExtension'] : ''; ?>" >
        </div>
        <div class="form-group">
            <label for="claimantSex">Sex</label>
            <select class="form-control" id="claimantSex" name="claimantSex">
                <option <?php echo isset($row['claimantSex']) && $row['claimantSex'] == 'Male' ? 'selected' : ''; ?>>Male</option>
                <option <?php echo isset($row['claimantSex']) && $row['claimantSex'] == 'Female' ? 'selected' : ''; ?>>Female</option>
            </select>
        </div>
        <div class="form-group">
            <label for="claimantBirthday">Birthday</label>
            <input type="date" class="form-control datepicker" id="claimantBirthday" name="claimantBirthday" placeholder="Select Birthday" required value="<?php echo isset($row['claimantBirthday']) ? $row['claimantBirthday'] : ''; ?>">
        </div>
        <div class="form-group">
            <label for="claimantAge">Age</label>
            <input type="number" class="form-control" id="claimantAge" name="claimantAge" placeholder="Enter Age" readonly value="<?php echo isset($row['claimantAge']) ? $row['claimantAge'] : ''; ?>">
        </div>
        <div class="form-group">
            <label for="claimantContactNumber">Contact Number</label>
            <input type="text" class="form-control" id="claimantContactNumber" name="claimantContactNumber" placeholder="Enter Contact Number" maxlength="11" value="<?php echo isset($row['claimantContactNumber']) ? $row['claimantContactNumber'] : ''; ?>" >
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="claimantCivilStatus" name="claimantCivilStatus" onchange="toggleClaimantSpouseField()">
                <option value="Single" <?php echo isset($row['claimantCivilStatus']) && $row['claimantCivilStatus'] == 'Single' ? 'selected' : ''; ?>>Single</option>
                <option value="Married" <?php echo isset($row['claimantCivilStatus']) && $row['claimantCivilStatus'] == 'Married' ? 'selected' : ''; ?>>Married</option>
                <option value="Separated" <?php echo isset($row['claimantCivilStatus']) && $row['claimantCivilStatus'] == 'Separated' ? 'selected' : ''; ?>>Separated</option>
                <option value="Widow" <?php echo isset($row['claimantCivilStatus']) && $row['claimantCivilStatus'] == 'Widow' ? 'selected' : ''; ?>>Widow</option>
            </select>
        </div>
        ...
        <div class="form-group" id="claimantSpouseField" style="display: none;">
            ...
            <input type="text" class="form-control" id="claimantSpouseName" name="claimantSpouseName" placeholder="Enter Spouse/Partner Name" value="<?php echo isset($row['claimantSpouseName']) ? $row['claimantSpouseName'] : ''; ?>">
        </div>
    </div>
</div>
        <br>
        <button type="submit" id="resubmitButton" class="btn btn-primary" name="submit">Resubmit</button>
...
function printLandTitle() {
    var landID = "<?php echo isset($notif_id) ? $notif_id : ''; ?>";
    console.log('Land ID:', landID); // This will help you see what value landID has
    if (landID) {
    ...
    document.getElementById('submitButton').addEventListener('click', function(event) {
        // Show confirmation dialog
        var confirmUpdate = confirm("Are you sure you want to resubmit this information?");
