...
<?php include 'user_navbar.php'; ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3>List of Your Verified Land Title</h3>
        <div class="d-flex">
...
<div class="table-responsive">
    <table class="table table-striped" id="printableTable">
        ...
        <tbody id="landTableBody">
            <?php
            // Query to retrieve verified land records for the logged-in user
            $sql = "SELECT verified_landID, lot_number, status AS land_category, 
                           date_approved, applicant_name, survey_claimant_name, 
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr id='row-" . $row["verified_landID"] . "'>
                            ...
                            <td class='actions-column'>
                                <a href='user_viewland.php?id=" . $row["verified_landID"] . "' class='btn btn-warning btn-sm'>
