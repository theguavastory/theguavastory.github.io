...
<head>
    ...
    <style>
        ...
        .user-info .username {
         ...
         /* Define initial style for the notification count */
    .notification-count {
        ...
        .table {
            ...
            table-layout: fixed; /* Distribute space equally */
        }
...
<div class="sidebar">
    ...
    <a href="userapplicant_list.php"><i class="fas fa-user"></i> Applicant</a>
    <a href="user_survey_claimant_list.php"><i class="fas fa-map-marker-alt"></i> Survey Claimant</a>
    <a href="user_disapprove.php"><i class="fas fa-times-circle"></i> Disapprove Titles</a>
                    ...
                    <td>
                        <form method='POST' action='notification_submit.php'>
                            <input type='hidden' name='notif_id' value='" . $row["notif_id"] . "'>
                             <a href='user_notif_edit.php?id=" . $row["notif_id"] . "' class='btn btn-warning btn-sm onclick='return confirmEdit();'><i class='fas fa-eye'></i></a>
                            </button>
                        </form>
                    </td>
                </tr>";
