                ...
                <?php foreach ($results as $row): ?>
                    <tr>
                        ...
                        <td class='actions-column'>
                            <a href="user_viewland.php?id=<?php echo htmlspecialchars($row['verified_landID']); ?>" class="btn btn-warning btn-sm" onclick="return confirmEdit();">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="GET" action="user_advanced_filter.php">
                    <!-- Status Checkboxes -->
