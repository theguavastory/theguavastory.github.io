  ...
  <form method="POST" action="update_land_title.php">
        ...
        <div class="card">
            <div class="card-header">
                <h4>Update Verified Land Title</h4>
            </div>
            <div class="card-body">
                <div class="form-group">
                    <label for="lot_number">Lot Number</label>
                    <input type="text" class="form-control" id="lot_number" name="lot_number" placeholder="Enter Lot Number" value="<?php echo isset($row['lot_number']) ? $row['lot_number'] : ''; ?>">
                </div>
                        <div>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="applicantLastName" name="applicantLastName" placeholder="Enter Last Name" value="<?php echo isset($applicantRow['applicantLastName']) ? $applicantRow['applicantLastName'] : ''; ?>">
        </div>
        <div class="form-group">
            <label for="applicantFirstName">First Name</label>
            <input type="text" name="applicantFirstName" class="form-control" id="applicantFirstName" placeholder="Enter First Name" value="<?php echo isset($applicantRow['applicantFirstName']) ? $applicantRow['applicantFirstName'] : ''; ?>">
        </div>
        <div class="form-group">
            <label for="applicantMiddleName">Middle Name</label>
            <input type="text" class="form-control" name="applicantMiddleName" id="applicantMiddleName" placeholder="Enter Middle Name" value="<?php echo isset($applicantRow['applicantMiddleName']) ? $applicantRow['applicantMiddleName'] : ''; ?>">
        </div>
                <div class="form-group form-check">
            <input type="checkbox" class="form-check-input" id="extensionCheck" <?php echo isset($applicantRow['applicantExtension']) && $applicantRow['applicantExtension'] ? 'checked' : ''; ?>>
            <label class="form-check-label" for="extensionCheck">Extensions</label>
            <input type="text" class="form-control mt-2" name="applicantExtension" id="applicantExtension" placeholder="Enter Extensions" style="<?php echo isset($applicantRow['applicantExtension']) && $applicantRow['applicantExtension'] ? '' : 'display: none;'; ?>" value="<?php echo isset($applicantRow['applicantExtension']) ? $applicantRow['applicantExtension'] : ''; ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="applicantBirthday" name="applicantBirthday" placeholder="Select Birthday" required value="<?php echo isset($applicantRow['applicantBirthday']) ? $applicantRow['applicantBirthday'] : ''; ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="applicantContactNumber" name="applicantContactNumber" placeholder="Enter Contact Number" maxlength="11" value="<?php echo isset($applicantRow['applicantContactNumber']) ? $applicantRow['applicantContactNumber'] : ''; ?>">
        </div>
        ...
        <div class="form-group" id="spouseField" style="display: none;">
            ...
            <input type="text" class="form-control" id="applicantSpouseName" name="applicantSpouseName" placeholder="Enter Spouse/Partner Name" value="<?php echo isset($applicantRow['applicantSpouseName']) ? $applicantRow['applicantSpouseName'] : ''; ?>">
        </div>
        </div>
            </div>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="claimantLastName" name="claimantLastName" placeholder="Enter Last Name" value="<?php echo isset($claimantRow['claimantLastName']) ? $claimantRow['claimantLastName'] : ''; ?>">
        </div>
        <div class="form-group">
            <label for="claimantFirstName">First Name</label>
            <input type="text" class="form-control" id="claimantFirstName" name="claimantFirstName" placeholder="Enter First Name" value="<?php echo isset($claimantRow['claimantFirstName']) ? $claimantRow['claimantFirstName'] : ''; ?>">
        </div>
        <div class="form-group">
            <label for="claimantMiddleName">Middle Name</label>
            <input type="text" class="form-control" id="claimantMiddleName" name="claimantMiddleName" placeholder="Enter Middle Name" value="<?php echo isset($claimantRow['claimantMiddleName']) ? $claimantRow['claimantMiddleName'] : ''; ?>">
        </div>
                <div class="form-group form-check">
            <input type="checkbox" class="form-check-input" id="claimantExtensionCheck" <?php echo isset($claimantRow['claimantExtension']) && $claimantRow['claimantExtension'] ? 'checked' : ''; ?>>
            <label class="form-check-label" for="claimantExtensionCheck">Extensions</label>
            <input type="text" class="form-control mt-2" name="claimantExtension" id="claimantExtension" placeholder="Enter Extensions" style="<?php echo isset($claimantRow['claimantExtension']) && $claimantRow['claimantExtension'] ? '' : 'display: none;'; ?>" value="<?php echo isset($claimantRow['claimantExtension']) ? $claimantRow['claimantExtension'] : ''; ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control datepicker" id="claimantBirthday" name="claimantBirthday" placeholder="Select Birthday" required value="<?php echo isset($claimantRow['claimantBirthday']) ? $claimantRow['claimantBirthday'] : ''; ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="claimantContactNumber" name="claimantContactNumber" placeholder="Enter Contact Number" maxlength="11" value="<?php echo isset($claimantRow['claimantContactNumber']) ? $claimantRow['claimantContactNumber'] : ''; ?>">
        </div>
            ...
            <div class="form-group" id="claimantSpouseField" style="display: none;">
                ...
                <input type="text" class="form-control" id="claimantSpouseName" name="claimantSpouseName" placeholder="Enter Spouse/Partner Name" value="<?php echo isset($claimantRow['claimantSpouseName']) ? $claimantRow['claimantSpouseName'] : ''; ?>">
            </div>
        </div>
    </div>
        <br>
        <input type="hidden" name="verified_landID" value="<?php echo isset($verified_landID) ? $verified_landID : ''; ?>">
                ...
                <button type="submit"   id="archiveButton" class="btn btn-warning" name="archive">Archive</button>
...
document.getElementById('coordinatesForm').addEventListener('submit', function(event) {
    ...
    document.getElementById('archiveButton').addEventListener('click', function(event) {
        // Show confirmation dialog
        var confirmUpdate = confirm("Are you sure you want to archive the land title?");
    ...
    document.getElementById('updateButton').addEventListener('click', function(event) {
        // Show confirmation dialog
        var confirmUpdate = confirm("Are you sure you want to update the information?");
...
<?php include 'edit_barangays.php'; ?>
<script>
